...
d3.json("data/he2017.json", function(data) {
    ...
    .selectAll("g")
        .data(dataTimeTable)
    .enter().append("g")
        .attr("class", function(d) { return "train_detail t_" + d.route; })
    .selectAll("g")
